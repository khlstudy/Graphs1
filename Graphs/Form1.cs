...
namespace Graphs
{
    public partial class frmGraphics : Form
    {
        public frmGraphics()
        {
            ...
            cbGraphics.Items.Add("Графік кв. корінь(x)");
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    switch (cbGraphics.SelectedIndex)
                    {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            txtZnach.Text += "x[" + i.ToString() + "] = " + Convert.ToString(x[i]) + "  " + "y5[" + i.ToString() + "] = " + Convert.ToString(Math.Round(y4[i], 5)) + Environment.NewLine;
                            break;
